<!-- Generated by skill-sync; source=/Users/liuqianli/work/skills/go-api-layer -->
# Trae Skill: go-api-layer

Go API/handler/controller 层专家。Use when writing, refactoring, or reviewing Gin/HTTP handlers, request binding, query/body params, response DTOs, pagination responses, service calls, JSONOK/JSONError, or API layer conventions.
