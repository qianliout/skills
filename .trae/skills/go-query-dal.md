<!-- Generated by skill-sync; source=/Users/liuqianli/work/skills/go-query-dal -->
# Trae Skill: go-query-dal

Go DAL/DAO 数据访问层专家。Use when writing, refactoring, or reviewing GORM queries, Search/Create/Update/Delete methods, pagination, Count + Find, context timeout, TableName, Serialize/Deserialize, ToUpdater, AddFilter, query params, update params, or PostgreSQL-compatible data access.
