<!-- Generated by skill-sync; source=/Users/liuqianli/work/skills/go-logging -->
# Trae Skill: go-logging

Go 日志规范专家。Use when writing, refactoring, or reviewing logging, logger initialization, module/subModule fields, LogStr, error logs, panic recover logs, service/API logging, avoiding DAL/model logs, duplicate logs, sensitive data, or large payload logging.
