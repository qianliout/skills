...
from runtime_tools import node_binary, runtime_bin_dir, runtime_env  # noqa: E402
...
def calc_dpi_via_pdf(input_path: str, max_w_px: int, max_h_px: int) -> int:
    ...
    info = pdfinfo_from_path(input_path, poppler_path=runtime_bin_dir())
