...
2. 读取 `references/gin-openapi-json.md`、`references/gin-openapi-json-conventions.md`、`references/api-layer.md` 和 `references/api-layer-conventions.md`。
...
- 目标接口范围明确。
- 已读取本 Skill 的 Go OpenAPI 和 API layer references。
